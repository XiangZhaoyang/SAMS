...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-04-30 15:34:27
...
CREATE TABLE `classes` (
  `classes_id` int(8) UNSIGNED NOT NULL COMMENT '班级编号',
  `classes_name` varchar(15) NOT NULL COMMENT '班级名称',
  `classes_department_id` int(8) UNSIGNED NOT NULL COMMENT '班级所属院系',
  `classes_majorName` varchar(20) NOT NULL COMMENT '班级专业',
  `classes_information` text COMMENT '班级信息'
...
CREATE TABLE `course` (
  `course_id` int(8) UNSIGNED NOT NULL COMMENT '课程编号',
  `course_teacher_id` bigint(12) UNSIGNED NOT NULL COMMENT '任课教师编号',
  `course_classes_id` int(8) UNSIGNED NOT NULL COMMENT '课程班级',
  `course_department_id` int(8) UNSIGNED NOT NULL COMMENT '课程所属院系编号',
  `course_belong` varchar(10) DEFAULT NULL COMMENT '课程所属类型',
  `course_style` varchar(10) NOT NULL COMMENT '课程类型',
  `course_credit` tinyint(1) NOT NULL COMMENT '课程学分',
  `course_name` varchar(15) NOT NULL COMMENT '课程名称',
  `course_year` char(9) NOT NULL COMMENT '课程学年',
  `course_term` tinyint(1) NOT NULL COMMENT '课程学期',
  `course_information` text COMMENT '课程信息',
  `course_add` tinyint(1) NOT NULL DEFAULT '0' COMMENT '课程是否生成成绩表',
  `course_rebuild` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否是重修课程'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `course` (`course_id`, `course_teacher_id`, `course_classes_id`, `course_department_id`, `course_belong`, `course_style`, `course_credit`, `course_name`, `course_year`, `course_term`, `course_information`, `course_add`, `course_rebuild`) VALUES
(21212101, 200120012001, 10000001, 10101010, NULL, '专业必选', 4, 'c++程序设计', '2014-2015', 1, NULL, 1, 0),
(21212102, 200120012003, 10000001, 10101010, NULL, '专业必修', 5, '操作系统', '2014-2015', 1, NULL, 0, 0),
(21212103, 200120012001, 10000001, 10101010, NULL, '专业必修', 4, '操作系统', '2015-2016', 1, NULL, 0, 0),
(21212104, 200120012001, 10000002, 10101010, NULL, '专业限选', 3, '软件工程', '2015-2016', 1, NULL, 0, 0),
(21212121, 200120012001, 10000001, 10101010, NULL, '专业必修', 3, 'C语言', '2013-2014', 2, NULL, 0, 0);
...
CREATE TABLE `department` (
  `department_id` int(8) UNSIGNED NOT NULL COMMENT '院系编号',
  `department_name` varchar(15) NOT NULL COMMENT '院系名称',
  `department_information` text COMMENT '院系信息'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `score` (
  `score_id` int(9) NOT NULL COMMENT '成绩编号',
  `score_course_id` int(8) UNSIGNED NOT NULL COMMENT '课程编号',
  `score_student_id` bigint(12) UNSIGNED NOT NULL COMMENT '学生学号',
  `score_score` float(5,2) DEFAULT NULL COMMENT '成绩分数',
  `score_gpa` float(2,1) DEFAULT NULL COMMENT '成绩绩点',
  `score_pass` tinyint(1) DEFAULT NULL COMMENT '是否通过',
  `score_second` float(5,2) DEFAULT NULL COMMENT '补考成绩',
  `score_add` tinyint(1) DEFAULT '0' COMMENT '成绩是否录入',
  `score_information` text COMMENT '成绩信息'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `score` (`score_id`, `score_course_id`, `score_student_id`, `score_score`, `score_gpa`, `score_pass`, `score_second`, `score_add`, `score_information`) VALUES
(2, 21212101, 201301094102, 33.00, 3.8, 1, 88.00, 1, NULL),
(3, 21212101, 201301094103, 73.00, 2.3, 1, NULL, 1, NULL),
(4, 21212101, 201301094134, 78.00, 2.8, 1, NULL, 1, NULL),
(5, 21212101, 201301094101, 98.00, 4.8, 1, NULL, 1, NULL);
...
CREATE TABLE `student` (
  `student_id` bigint(12) UNSIGNED NOT NULL COMMENT '学号',
  `student_classes_id` int(8) UNSIGNED NOT NULL COMMENT '班级编号',
  `student_sex` tinyint(1) NOT NULL COMMENT '性别',
  `student_name` varchar(10) NOT NULL COMMENT '姓名',
  `student_brith` char(8) DEFAULT NULL COMMENT '出生日期',
  `student_address` varchar(30) DEFAULT NULL COMMENT '地址',
  `student_imghref` varchar(20) DEFAULT NULL COMMENT '照片',
  `student_information` text COMMENT '信息',
  `student_phoneNum` bigint(11) DEFAULT NULL COMMENT '联系电话',
  `student_email` varchar(30) DEFAULT NULL COMMENT '电子邮箱',
  `student_idcard` bigint(18) DEFAULT NULL COMMENT '身份证'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `teacher` (
  `teacher_id` bigint(12) UNSIGNED NOT NULL COMMENT '教师编号',
  `teacher_department_id` int(8) UNSIGNED NOT NULL COMMENT '院系编号',
  `teacher_name` varchar(10) NOT NULL COMMENT '姓名',
  `teacher_sex` tinyint(1) NOT NULL COMMENT '性别',
  `teacher_brith` char(8) DEFAULT NULL COMMENT '出生日期',
  `teacher_address` varchar(30) DEFAULT NULL COMMENT '地址',
  `teacher_imghref` varchar(20) DEFAULT NULL COMMENT '照片',
  `teacher_information` text COMMENT '更多信息',
  `teacher_phoneNum` bigint(11) DEFAULT NULL COMMENT '联系电话',
  `teacher_email` varchar(30) DEFAULT NULL COMMENT '电子邮箱',
  `teacher_idvard` bigint(18) DEFAULT NULL COMMENT '身份证'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `user` (
  `user_id` bigint(12) UNSIGNED NOT NULL COMMENT '账号',
  `user_pass` varchar(256) NOT NULL DEFAULT '$2y$10$vZ0Wm.W7NbcZr9Bf7dDqzeYi/TG4FwIPEgrzqtJ8GsSXu9vclyuve' COMMENT '密码',
  `user_createTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `user_auth` tinyint(1) NOT NULL DEFAULT '3' COMMENT '用户权限'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `score`
  MODIFY `score_id` int(9) NOT NULL AUTO_INCREMENT COMMENT '成绩编号', AUTO_INCREMENT=6;
--
-- 限制导出的表
--
